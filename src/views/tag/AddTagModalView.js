...
import AddTagModalViewTmpl from 'hbs!tmpl/tag/AddTagModalView_tmpl';

import AddTimezoneItemView from 'views/tag/AddTimezoneItemView';
import VTagList from 'collection/VTagList';
import VCommonList from 'collection/VCommonList';
